...
if __name__=="__main__":
    ...
    x4y2=SrchStdOrdMstr.SStdOrdMstr()
    ...
    root.x4y2 = Button(root,text='条码配置查询', width=10,command=x4y2.gui)
    root.x4y2.grid(row=4, column=2,padx=10,pady=10)
